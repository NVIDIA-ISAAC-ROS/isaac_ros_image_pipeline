...
AxisAngleRotation RotationVectorToAxisAngleRotation(const Vector3d & rotVector) {
    double normVector = rotVector.x * rotVector.x + rotVector.y * rotVector.y
        + rotVector.z * rotVector.z;
...
AxisAngleRotation QuaternionToAxisAngleRotation(const Quaternion & qrotation) {
    ...
    if (qrotation.qw > 1) {
        double qnorm = qrotation.qx * qrotation.qx + qrotation.qy * qrotation.qy
            + qrotation.qz * qrotation.qz + qrotation.qw * qrotation.qw;
