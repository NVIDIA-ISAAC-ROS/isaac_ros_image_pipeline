...
template<TensorLayout TL, ChannelCount CC, ChannelType CT>
struct is_planar<Tensor<TL, CC, CT>> : std::integral_constant<bool,
    TL == CHW || TL == DCHW || TL == CDHW> {
};
...
template<TensorLayout TL, ChannelCount CC, ChannelType CT>
struct is_interleaved<Tensor<TL, CC, CT>> : std::integral_constant<bool,
    TL == HWC || TL == DHWC> {
};
...
template<TensorLayout TL, ChannelCount CC, ChannelType CT>
struct is_batch<Tensor<TL, CC, CT>> : std::integral_constant<bool,
    TL == DHWC || TL == DCHW || TL == CDHW> {
};
