...
gxf_result_t ConvertColorFormatImpl(gxf::Entity& output, gxf::Entity& input,
  ...
  if (!cvcore::tensor_ops::ConvertColorFormat(output_image.value(),
      input_image.value(), type, stream)) {
    return GXF_FAILURE;
  }
  return GXF_SUCCESS;
}
...
template<cvcore::tensor_ops::ImageType T_IN, cvcore::tensor_ops::ImageType T_OUT>
gxf_result_t ConvertColorFormatStreamImpl(
...
gxf_result_t ConvertColorFormatBase<USE_TENSOR_STREAM>::registerInterface(
...
template<bool USE_TENSOR_STREAM>
gxf::Expected<ImageInfo> ConvertColorFormatBase<USE_TENSOR_STREAM>::doInferOutputInfo(
    gxf::Entity& input) {
  // Set output type
...
template<bool USE_TENSOR_STREAM>
gxf_result_t ConvertColorFormatBase<USE_TENSOR_STREAM>::doUpdateCameraMessage(
...
#define DEFINE_CONVERT_COLOR_FORMAT(INPUT_TYPE, OUTPUT_TYPE, CONVERSION_TYPE) \
  if (input_info_.type == INPUT_TYPE && output_info_.type == OUTPUT_TYPE) {   \
    return detail::ConvertColorFormatImpl<INPUT_TYPE, OUTPUT_TYPE>(           \
      ...
      output_adapter_.get(), input_adapter_.get(),                            \
...
template <>
gxf_result_t ConvertColorFormatBase<true>::doExecute(
    gxf::Entity& output, gxf::Entity& input, cudaStream_t stream, const char* output_name,
  ...
  DEFINE_STREAM_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_U8,
      cvcore::tensor_ops::ImageType::NV12);
  DEFINE_STREAM_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::NV24,
      cvcore::tensor_ops::ImageType::BGR_U8);
  DEFINE_STREAM_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_U8,
...
template <>
gxf_result_t ConvertColorFormatBase<false>::doExecute(
    gxf::Entity& output, gxf::Entity& input, cudaStream_t stream, const char* output_name,
    const char* input_name) {
  // Run the color conversion operation
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_U8,
      cvcore::tensor_ops::ImageType::BGR_U8,
      cvcore::tensor_ops::ColorConversionType::RGB2BGR);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_U16,
      cvcore::tensor_ops::ImageType::BGR_U16,
      cvcore::tensor_ops::ColorConversionType::RGB2BGR);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_F32,
      cvcore::tensor_ops::ImageType::BGR_F32,
      cvcore::tensor_ops::ColorConversionType::RGB2BGR);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_U8,
      cvcore::tensor_ops::ImageType::RGB_U8,
      cvcore::tensor_ops::ColorConversionType::BGR2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_U16,
      cvcore::tensor_ops::ImageType::RGB_U16,
      cvcore::tensor_ops::ColorConversionType::BGR2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_F32,
      cvcore::tensor_ops::ImageType::RGB_F32,
      cvcore::tensor_ops::ColorConversionType::BGR2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_U8,
      cvcore::tensor_ops::ImageType::Y_U8,
      cvcore::tensor_ops::ColorConversionType::RGB2GRAY);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_U16,
      cvcore::tensor_ops::ImageType::Y_U16,
      cvcore::tensor_ops::ColorConversionType::RGB2GRAY);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::RGB_F32,
      cvcore::tensor_ops::ImageType::Y_F32,
      cvcore::tensor_ops::ColorConversionType::RGB2GRAY);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_U8,
      cvcore::tensor_ops::ImageType::Y_U8,
  ...
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::BGR_F32,
      cvcore::tensor_ops::ImageType::Y_F32,
      cvcore::tensor_ops::ColorConversionType::BGR2GRAY);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::Y_U8,
      cvcore::tensor_ops::ImageType::RGB_U8,
      cvcore::tensor_ops::ColorConversionType::GRAY2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::Y_U16,
      cvcore::tensor_ops::ImageType::RGB_U16,
      cvcore::tensor_ops::ColorConversionType::GRAY2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::Y_F32,
      cvcore::tensor_ops::ImageType::RGB_F32,
      cvcore::tensor_ops::ColorConversionType::GRAY2RGB);
  DEFINE_CONVERT_COLOR_FORMAT(cvcore::tensor_ops::ImageType::Y_U8,
      cvcore::tensor_ops::ImageType::BGR_U8,
