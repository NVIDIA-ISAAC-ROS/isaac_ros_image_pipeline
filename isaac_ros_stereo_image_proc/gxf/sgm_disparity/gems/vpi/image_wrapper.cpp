...
gxf::Expected<void> ImageWrapper::createFromVideoBuffer(
  ...
  auto image_format = GXF_UNWRAP_OR_RETURN(vpi::VideoFormatToImageFormat(image_info.color_format));
  auto pixel_type = GXF_UNWRAP_OR_RETURN(vpi::VideoFormatToPixelType(image_info.color_format));
