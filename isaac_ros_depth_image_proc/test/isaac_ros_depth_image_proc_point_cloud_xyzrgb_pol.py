...
def generate_test_description():
    point_cloud_xyzrgb_node = ComposableNode(
        ...
        namespace=IsaacROSDepthImageProcPointCloudXyzrgbTest.generate_namespace(),
        parameters=[{
                'skip': SKIP
            }])
    ...
    return IsaacROSDepthImageProcPointCloudXyzrgbTest.generate_test_description(
        [container])


class IsaacROSDepthImageProcPointCloudXyzrgbTest(IsaacROSBaseTest):
    ...
    def test_xyzrgb_point_cloud(self, test_folder):
        ...
        self.generate_namespace_lookup(['depth_registered/image_rect', 'rgb/image_rect_color',
                                        'rgb/camera_info', 'points'])
