...
class IsaacROSImageFlipTest(IsaacROSBaseTest):
    ...
    def test_image_flip_horizontal(self, test_folder) -> None:
        """Expect the node to flip input horizontally."""
        ...
        try:
            ...
            groundtruth_image_cv = cv2.imread(str(test_folder / 'flipped_image_horizontal.png'))
