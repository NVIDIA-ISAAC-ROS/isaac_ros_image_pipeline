...
"""4-channel color conversion test for the Isaac ROS Image Format Converter node."""
...
def generate_test_description():
    ...
    composable_nodes = [
        launch_ros.descriptions.ComposableNode(
            ...
            namespace=IsaacROSFormatBGRATest.generate_namespace(),
            parameters=[{
    ...
    return IsaacROSFormatBGRATest.generate_test_description([format_container])


class IsaacROSFormatBGRATest(IsaacROSBaseTest):
    """Vaidate format conversion to the bgra8 format."""

    def test_rgba_to_bgra_conversion(self) -> None:
        """Expect the node to convert rgba8 input images into the bgra8 format."""
        ...
        try:
            ...
            image_mono_expected = cv2.cvtColor(cv_image, cv2.COLOR_RGBA2BGRA)
