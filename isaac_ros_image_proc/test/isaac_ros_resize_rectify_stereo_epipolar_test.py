...
"""Epipolar line validation test for the Isaac ROS Resize node + Rectify node."""
...
def generate_test_description():
    ...
    composable_nodes = [
         launch_ros.descriptions.ComposableNode(
            ...
            parameters=[{
                    'output_width': int(1920/4),
                    'output_height': int(1200/2)
            }],
            remappings=[
                ('image', 'left_image_raw'),
                ('camera_info', 'left_camera_info'),
                ('resize/image', 'left_image_raw_resized'),
                ('resize/camera_info', 'left_camera_info_resized'),
            ]),
         launch_ros.descriptions.ComposableNode(
            package='isaac_ros_image_proc',
            plugin='nvidia::isaac_ros::image_proc::ResizeNode',
            ...
            remappings=[
                ('image', 'right_image_raw'),
                ('camera_info', 'right_camera_info'),
                ('resize/image', 'right_image_raw_resized'),
                ('resize/camera_info', 'right_camera_info_resized'),
            ]),
         launch_ros.descriptions.ComposableNode(
            ...
            remappings=[
                ('image_raw', 'left_image_raw_resized'),
                ('camera_info', 'left_camera_info_resized'),
         ...
         launch_ros.descriptions.ComposableNode(
            ...
            remappings=[
                ('image_raw', 'right_image_raw_resized'),
                ('camera_info', 'right_camera_info_resized'),
