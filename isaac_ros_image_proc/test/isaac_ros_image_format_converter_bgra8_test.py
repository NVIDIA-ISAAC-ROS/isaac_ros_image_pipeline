...
"""rgb8 -> bgra8 conversion test for the Isaac ROS Image Format Converter node."""
...
def generate_test_description():
    ...
    composable_nodes = [
        launch_ros.descriptions.ComposableNode(
            ...
            namespace=IsaacROSFormatBGRA8Test.generate_namespace(),
            parameters=[{
    ...
    return IsaacROSFormatBGRA8Test.generate_test_description([format_container])


class IsaacROSFormatBGRA8Test(IsaacROSBaseTest):
    """Validate format conversion to the bgra8 format."""

    def test_rgb_to_bgra_conversion(self) -> None:
        """Expect the node to convert rgb8 input images into the bgra8 format."""
        ...
        try:
            ...
            image_expected = cv2.cvtColor(cv_image, cv2.COLOR_RGB2BGRA)
